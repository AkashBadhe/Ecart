...
export default function OrderDetailsPage() {
  ...
  const [generateInvoiceDownloadUrlMutation] = useGenerateInvoiceDownloadUrlMutation();
    ...
    <div>
      <Card>
        ...
        <div className="flex flex-col items-center lg:flex-row">
          ...
          {data?.order?.order_status !== OrderStatus.FAILED && data?.order?.order_status !== OrderStatus.CANCELLED && (
              <form
